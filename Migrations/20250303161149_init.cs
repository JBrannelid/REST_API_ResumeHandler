        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    School = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Educations_Persons_FKPersonId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Experiences_Persons_FKPersonId",
                        column: x => x.FKPersonId,
                        principalTable: "Persons",
                        principalColumn: "PersonId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Educations_FKPersonId",
                table: "Educations",
                column: "FKPersonId");

            migrationBuilder.CreateIndex(
                name: "IX_Experiences_FKPersonId",
                table: "Experiences",
                column: "FKPersonId");
        }
